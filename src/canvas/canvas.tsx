...
export function Canvas({
  ...
  // we flip it back below. **For an FSM this is a correctness bug, not
  // just a visual one**: Atom-Simulator reads edge.source / edge.target
  // directly and would step the automaton in the wrong direction.
